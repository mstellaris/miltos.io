...
export default ({ data: { site, article } }) => (
  <Layout>
    <Helmet>
      ...
      <meta name="twitter:title" content={`${article.frontmatter.title} - Miltos Stella`} />
      ...
      <meta property="og:title" content={`${article.frontmatter.title} - Miltos Stella`} />
