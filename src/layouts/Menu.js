        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                <Link to="/talks" onClick={() => setShowSidebar(false)}>
                  <FiMoreVertical />
                  Public Speaking
                </Link>
              </li>
              <li>
                <Link to="/galleries" onClick={() => setShowSidebar(false)}>
                  <FiMoreVertical />
                  DX Design Patterns
                </Link>
              </li>
          ...
          <li>
            ...
            <ul>
              <li>
                <a
                  href="https://twitter.com/milstella"
                  onClick={() => setShowSidebar(false)}
                >
                  <FiMoreVertical />
                  Twitter
              ...
              <li>
                <a
                  href="https://github.com/mstellaris"
                  onClick={() => setShowSidebar(false)}
                >
                  <FiMoreVertical />
                  GitHub
              ...
              <li>
                <a
                  href="https://linkedin.com/in/miltosstella"
                  onClick={() => setShowSidebar(false)}
                >
                  <FiMoreVertical />
                  LinkedIn
              ...
              <li>
                <a
                  href="https://youtube.com/channel/UC1t7fyynmADxMsyQmzicAAQ/"
                  onClick={() => setShowSidebar(false)}
                >
                  <FiMoreVertical />
                  YouTube
